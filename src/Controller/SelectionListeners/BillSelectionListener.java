...
/**
 * The BillSelectionListener class implements ListSelectionListener and handles events when selecting items in the bill table.
 * It provides functionality to remove selected items from the bill and update the total and subtotal amounts.
 */
public class BillSelectionListener implements ListSelectionListener {
    ...
    private JTable table;            // Reference to the bill table
